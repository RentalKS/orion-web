...
import { updateLocation } from "../../features/location/api";
import {
  Brand,
  Category,
  Company,
...
export function useUpdateCategory() {
  return useMutationHook<{
    ...
    mutationFn: ({ categoryId, updatedData }) =>
      updateCompany(categoryId, updatedData),
    queryKey: "categories",
  });
}
...
export function useUpdateSection() {
  return useMutationHook<{ sectionId: number; updatedData: Partial<Section> }>({
    mutationFn: ({ sectionId, updatedData }) =>
      updateCompany(sectionId, updatedData),
    queryKey: "sections",
  });
}
...
export function useUpdateLocation() {
  return useMutationHook<{
    ...
    mutationFn: ({ locationId, updatedData }) =>
...
export function useUpdateRateDate() {
  return useMutationHook<{
    rateDateId: number;
    updatedData: Partial<RateDate>;
  }>({
    mutationFn: ({ rateDateId, updatedData }) =>
      updateBrand(rateDateId, updatedData),
    queryKey: "rateDates",
  });
}
...
export function useUpdateVehicle() {
  return useMutationHook<{ vehicleId: number; updatedData: Partial<Vehicle> }>({
    mutationFn: ({ vehicleId, updatedData }) =>
      updateBrand(vehicleId, updatedData),
    queryKey: "vehicles",
  });
}
...
export function useUpdateReservation() {
  return useMutationHook<{
    ...
    mutationFn: ({ reservationId, updatedData }) =>
      updateBrand(reservationId, updatedData),
