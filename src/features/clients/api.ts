...
const STATIC_TEST_TOKEN =
  "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJzaHBhdHZhdGExQGdtYWlsLmNvbSIsImlhdCI6MTczOTU2MDYxOCwiZXhwIjoxNzM5NjQ3MDE4fQ.n3ad55Hv68Kyok-vN65s7YSO79W4dUO0RWD4KuzI8Js";
...
export async function deleteCustomer(customerId: number): Promise<void> {
  return api.delete<void>(`/api/customer/update/${customerId}`);
}
